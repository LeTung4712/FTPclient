...
login:
    ...
    {
        system("clear");
        printf("\033[38;5;226m--> Login failed !\033[0m\n");
        goto login;
    }
    else
    {
        printf("\033[38;5;226m--> Login successful !\033[0m\n");
    }
    ...
    while (1)
    {
        ...
        char command[1024] = {0};
        printf("        ---MENU---         \n"
               "(Current directory: \033[38;5;13m%s\033[0m)\n",
               get_current_dir(sfd));
        ...
        case 2:
            ...
            if (strstr(data, "550") == NULL)
                printf("\033[38;5;226m--> Directory changed successfully !\033[0m\n");
            else
                printf("\033[38;5;226m--> Directory change failed !\033[0m\n");
            break;
        case 3:
            ...
            if (strstr(data, "550") != NULL)
            {
                printf("\033[38;5;226m--> File not found !\033[0m\n");
                remove(file);
            }
            else if (strstr(data, "150") != NULL)
            {
                printf("\033[38;5;226m--> File downloaded \033[0m\n");
            }
            break;
        case 4:
            // Upload file
            ...
            {
                printf("\033[38;5;226m--> File uploaded \033[0m\n");
            }
            break;
        case 5:
            exit(0);
        default:
            printf("\033[38;5;226m--> Invalid choice !\033[0m\n");
            break;
        }
    }
}